...
subject_prices = {"CHINESE": 120, "MALAY": 150, "ENGLISH": 90, "MATHS": 150, "SCIENCE": 120}

def give_subjectlist():
    return subject_list

def give_schedule(subject,day, level):
    with open("Data files/SubjectSchedules.txt") as f:
        subject_schedule = json.load(f)
    return subject_schedule.get(subject, "Not valid subject").get(day, "Not valid day")[level-1]
